...
$executable = Join-Path $output 'SystemMonitorWidget-v2.5.6.exe'
...
$bundle = Join-Path $output 'SystemMonitorWidget-v2.5.6-win-x64.zip'
$checksum = Join-Path $output 'SystemMonitorWidget-v2.5.6-win-x64.sha256.txt'
