...
$executable = Join-Path $output 'SystemMonitorWidget-v2.5.5.exe'
...
$bundle = Join-Path $output 'SystemMonitorWidget-v2.5.5-win-x64.zip'
$checksum = Join-Path $output 'SystemMonitorWidget-v2.5.5-win-x64.sha256.txt'
