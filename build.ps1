...
$executable = Join-Path $output 'SystemMonitorWidget-v2.6.0.exe'
...
$bundle = Join-Path $output 'SystemMonitorWidget-v2.6.0-win-x64.zip'
$checksum = Join-Path $output 'SystemMonitorWidget-v2.6.0-win-x64.sha256.txt'
