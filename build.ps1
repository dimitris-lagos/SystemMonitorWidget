...
$executable = Join-Path $output 'SystemMonitorWidget-v2.5.4.exe'
...
$bundle = Join-Path $output 'SystemMonitorWidget-v2.5.4-win-x64.zip'
$checksum = Join-Path $output 'SystemMonitorWidget-v2.5.4-win-x64.sha256.txt'
