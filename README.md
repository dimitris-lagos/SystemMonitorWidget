...
The compiled executable is written to `artifacts\SystemMonitorWidget-v2.4.3.exe`.
...
1. Download `SystemMonitorWidget-v2.4.3.exe` from the [latest release](../../releases/latest).
2. Open HWiNFO64 settings and enable **Shared Memory Support**.
3. Start HWiNFO sensors.
4. Run `SystemMonitorWidget-v2.4.3.exe`.
